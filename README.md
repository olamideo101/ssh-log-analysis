...
This project focuses on analyzing SSH authentication activity on a Linux system to identify failed login attempts, successful logins, and potentially suspicious behavior. The goal of the project is to understand how SSH authentication works in real environments and how system logs can be used for basic security monitoring and incident awareness.

The project combines manual log inspection using Linux commands with automated analysis using a Python script. This mirrors how entry level security and IT professionals investigate authentication events in real systems.
